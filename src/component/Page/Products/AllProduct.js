...
const AllProduct = ({ DeleteToProduct, product }) => {
            ...
            <div className='border-2 border-gray-200 border-opacity-60 rounded-lg p-5'>
                ...
                <div className="mt-4">
                    ...
                    <div className='flex justify-between items-center'>
                        ...
                        <button onClick={() => DeleteToProduct(_id)} className="bg-red-500 hover:bg-cyan-400 text-white font-bold py-2 px-4 rounded mt-5">
                            Delete
                        </button>
                    </div>
                </div>
